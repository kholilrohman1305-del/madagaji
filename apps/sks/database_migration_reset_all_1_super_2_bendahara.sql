...
-- 3) Sisakan 1 super admin + 2 bendahara (role admin)
--
...
VALUES
  (1, 'PUSAT', 'Kantor Pusat', 1),
  (2, 'BND-A', 'Cabang Bendahara A', 1),
  (3, 'BND-B', 'Cabang Bendahara B', 1);
...
VALUES
  ...
  (2, 'bendahara_a', '$2b$10$2BZKEQuiJjRC7jUqZiuGi.VVzZYexeDPLxMrbcaLBFb04Yt2K0Z1y', 'Bendahara Cabang A', 'admin', 2, NULL, NULL),
  (3, 'bendahara_b', '$2b$10$2BZKEQuiJjRC7jUqZiuGi.VVzZYexeDPLxMrbcaLBFb04Yt2K0Z1y', 'Bendahara Cabang B', 'admin', 3, NULL, NULL);
